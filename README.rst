...
Frontend apps are npm packages that plug into the frontend-base site. This plugin ships with three core frontend apps disabled by default:
...
To enable the included apps, use the ``tutormfe.hooks.FRONTEND_APPS`` filter:
